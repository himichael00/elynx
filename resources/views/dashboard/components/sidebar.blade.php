...
<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
        <img src="{{ asset('img/tva-2.svg') }}" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
        <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">TVA Blog Dashboard</span>
      </a>
    </div>
      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm my-0 mx-4 flex items-center whitespace-nowrap px-4 font-semibold text-slate-700 hover:bg-orange-500 hover:shadow-soft-2xl rounded-lg
            {{ Request::is('dashboard') ? 'bg-orange-500 shadow-soft-2xl text-white' : '' }}" href="/dashboard">
            <div class="from-orange-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white">
              <div class="shrink-0">
                <img class="size-6" src="{{ asset('./assets/img/outline/house-2.svg') }}" alt="Home">
              </div>
                <title>Home</title>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm my-0 mx-4 flex items-center whitespace-nowrap px-4 font-semibold text-slate-700 hover:bg-orange-500 hover:shadow-soft-2xl rounded-lg
            ...
            <div class="from-orange-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white">
              <div class="shrink-0">
                <img class="size-6" src="{{ asset('./assets/img/outline/box.svg') }}" alt="My Posts">
              </div>
        ...
        @can('IsAdmin')
          <h6 class="sidevar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm my-0 mx-4 flex items-center whitespace-nowrap px-4 font-semibold text-slate-700 hover:bg-orange-500 hover:shadow-soft-2xl rounded-lg
              {{ Request::is('dashboard/categories*') ? 'bg-orange-500 shadow-soft-2xl text-white' : '' }}" href="/dashboard/categories">
              <div class="from-orange-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white">
                <div class="shrink-0">
                  <img class="size-6" src="{{ asset('./assets/img/outline/folder.svg') }}" alt="Categories">
                </div>
